const books = [
    ...
    {
      pdf: "https://ri.ufs.br/bitstream/riufs/6953/2/Marina_Amaral_Oliveira.pdf",
    ...
    {
      pdf: "https://www.escolahenriquemedina.org/bibdigital/view/1788/Cem%20Anos%20de%20Solidao%20-%20Gabriel%20Garcia%20Marquez.pdf",
    ...
    {
      pdf: "https://maisdiferencas.org.br/wp-content/themes/maisdiferencas/downloads/o_pequeno_principe/original.pdf",
    ...
    {
      pdf: "https://www.dhnet.org.br/direitos/anthist/marcos/hdh_george_orwell_revolucao_bichos.pdf",
  ...
  //Função para adicionar livros a pagina
  ...
  function searchBooks() { 
    ...
    const query = searchInput.value.toLowerCase(); // Remove espaço do texto 
